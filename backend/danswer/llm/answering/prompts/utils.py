from backend.danswer.prompts.direct_qa_prompts import PARAMATERIZED_PROMPT
from backend.danswer.prompts.direct_qa_prompts import PARAMATERIZED_PROMPT_WITHOUT_CONTEXT
