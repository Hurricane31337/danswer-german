...
from backend.danswer.configs.constants import KV_GOOGLE_DRIVE_CRED_KEY
from backend.danswer.configs.constants import KV_GOOGLE_DRIVE_SERVICE_ACCOUNT_KEY
...
from backend.danswer.connectors.google_drive.constants import SCOPES
