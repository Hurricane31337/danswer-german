    ...
    values: [
      {
        type: "text",
        query:
          "Gib die Website-URL zum Einlesen ein, z.B. https://handbuch.mylabelwin.de/:",
        label: "Basis-URL",
        name: "base_url",
        optional: false,
      },
      {
        type: "number",
        query: "Gib die neuste aktuell verfügbare Handbuch-Version ein, z.B. 100:",
        label: "Version",
        name: "version",
        description:
          "Die Handbuch-Version sollte immer auf die neuste aktuell verfügbare Labelwin-Version gestellt werden. Mehrere Handbuch-Versionen parallel zu indizieren ergibt wahrscheinlich wenig Sinn.",
        optional: false,
      },
      {
        type: "select",
