      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          rerank_api_url: Yup.string()
            ...
            .matches(/^https?:\/\//, "URL muss mit http:// oder https:// beginnen")
            .nullable(),
        })}
              ...
              <Form>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-xs text-gray-500">
                          {card.cloud ? "Cloud-basiert" : "Self-gehostet"}
                        </div>
                      </div>
                    );
                  })}
                ...
                {showGpuWarningModalModel && (
                  <Modal
                    ...
                    title="GPU nicht aktiviert"
                  >
                    <>
                      <p className="text-error font-semibold">Warning:</p>
                      <p>
                        Lokale Reranking-Modelle erfordern erhebliche Rechenleistung
                        und könnten ohne GPU-Beschleunigung langsam ausgeführt werden.
                        Erwäge den Wechsel zu einer GPU-fähigen Infrastruktur oder
                        die Verwendung einer Cloud-basierten Alternative für bessere
                        Performance.
                      </p>
